...
export const apagar = async ({ commit }, id) => {
  try {
    ...
    const res = await axios.delete('armazem/apagar/' + id)
...
export const editar = async ({ commit }, dados) => {
  try {
    ...
    const res = await axios.put('armazem/editar', dados)
...
export const exibir = async ({ commit }, id) => {
  try {
    ...
    const res = await axios.get('armazem/exibir/' + id)
...
export const listar = async ({ commit }, parametros) => {
  try {
    ...
    const res = await axios.get('armazem/listar', {
      params: parametros
    })
...
export const salvar = async ({ commit }, dados) => {
  try {
    ...
    const res = await axios.post('armazem/salvar', dados)
